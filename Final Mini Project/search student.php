            ...
            <div class="form-popup" id="myForm1">
                <div class="form-group">
                    <form method="POST" action="student_details.php">
                        ...
                        <input type="text" placeholder="ENTER SEMESTER" name="Semester" id="Semester"  class="form-control" required>
                        
                     
                       
                        <div class="dropdown" style="margin-top:20px;">
                      
                            <select   type="text"  name="Student_Department" id="Student_Department">
